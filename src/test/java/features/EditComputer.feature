Feature: Edit computer
  ...
  @browser
  Scenario: Verify that user is unable to update computer with all fields empty
  ...
  @browser
  Scenario Outline: Verify that user is unable to update computer with empty required field
  ...
  @browser
  Scenario Outline: Verify that user is unable to update computer with wrong date format for Introduced	date field
  ...
  @browser
  Scenario Outline: Verify that user is unable to update computer with wrong date format for Discontinued date field
    And I enter <name> in Computer name field
  ...
  @browser
  Scenario Outline: Verify that user is able to update computer with all valid data
    And I enter <name> in computer name field
    And I enter valid <introduced> date, <discontinued> date and <companyBrand>
    When I click on the button Save this computer
